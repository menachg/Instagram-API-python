...
class InstagramAPI:
    ...
    def getUserId(self,profileName):
        req=requests.get("https://www.instagram.com/"+profileName+"?__a=1")
        return (json.loads(req.text))["user"]["id"]
    ...
    #example: api.sendMessage(target_id_here,messagetext here)
